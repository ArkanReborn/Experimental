...
def input_day_of_week():
  day = input("What day of the week does January 1 begin on, (ex. Sunday, Monday, Tuesday, etc.): ")

  days_of_week = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"]

  while day.lower() not in days_of_week:
    day = input("ERROR: Enter Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, or Saturday: ")
